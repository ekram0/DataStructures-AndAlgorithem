            ...
            while (!quitSeen)
            {
                ...
                switch (cmd.Verb)
                {
                    ...
                    case Commands.Commands.Add:
                        quitSeen = true;
                        break;
                    case Commands.Commands.Dump:
                        DumpFlightRecorder();
                        break;
                    case Commands.Commands.Undo:
                        UndoLastAction();
                        break;
                    case Commands.Commands.List:
                        PrintList(cmd.Execute);
                        break;
                    case Commands.Commands.Find:
                        PrintList(cmd.Execute);
                        break;
                    default:
